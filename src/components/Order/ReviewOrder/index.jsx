...
const ReviewOrder = () => {
   ...
   return (
      <form
         ...
         {orderData?.getAllOrderData ? (
            orderData?.getAllOrderData.map((order, index) => (
               <Card
                  loading={orderData?.getAllOrderLoader}
                  key={index}
                  className="w-full max-w-4xl shadow-md p-6">
                  <Row justify="w-full flex items-center justify-between space-x-4">
                  ...
                  {/* Action Buttons (Delete Order and Proceed to Payment) */}
                  <div className="flex justify-between">
                     {/* Delete Order Button */}
                     <Row justify="end">
                        <Button
                           loading={orderData?.deleteOrderLoader}
            ...
            <div className="text-center">
               <img
                  src="https://cdn.dribbble.com/users/9620200/screenshots/17987839/media/fd60cc8251e50a8c54d3dde620ff9460.jpg"
                  alt=""
               />
            </div>
         )}
